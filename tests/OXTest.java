...
class OXTest {
    ...
    void checkWinCol0(){
        ...
        ox.put(0,1);
        ox.put(0,2);
        assertTrue(ox.chackwin(0,0));
        assertTrue(ox.chackwin(0,1));
        assertTrue(ox.chackwin(0,2));
        assertFalse(ox.chackwin(1,0));
        assertFalse(ox.chackwin(1,1));
        assertFalse(ox.chackwin(1,2));
    }
    @Test
    void checkWinCol2(){
        OX ox = new OX();
        ...
        ox.put(2,1);
        ox.put(2,2);
        assertTrue(ox.chackwin(2,0));
        assertTrue(ox.chackwin(2,1));
        assertTrue(ox.chackwin(2,2));
        assertFalse(ox.chackwin(1,0));
        assertFalse(ox.chackwin(1,1));
        assertFalse(ox.chackwin(1,2));
    }
    ...
    void checkWinRo2(){
        ...
        ox.put(2,2);
        assertTrue(ox.chackwin(0,2));
        assertTrue(ox.chackwin(1,2));
        assertTrue(ox.chackwin(2,2));
        assertFalse(ox.chackwin(1,0));
        assertFalse(ox.chackwin(1,1));
        assertFalse(ox.chackwin(2,1));
    }
    @Test
    void checkWines(){
        OX ox = new OX();
